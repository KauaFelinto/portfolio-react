...
function Skills(){
  return(
    <section className="habilidades" id="Skills">
      <h3 className="titulo">Técnologias</h3>
      <div className="skills">
        ...
        <img src="https://angular.io/assets/images/logos/angular/angular_whiteTransparent.png" alt="icone" id="icon"/>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpJQH755t5dniOYwR_nSPxtMBVFa3mwMg2sA&usqp=CAU" alt="icone" id="icon"/>
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/640px-React-icon.svg.png" alt="icone" id="react"/>
        <img src="https://www.tshirtgeek.com.br/wp-content/uploads/2021/09/com037-scaled.jpg" alt="icone" id="icon"/>
      </div>

      <div className="description">
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum autem eum sequi aliquid aspernatur perspiciatis architecto exercitationem doloribus, ratione eaque consectetur nihil iusto, vitae odio eligendi quia, id blanditiis officiis?</p>
      </div>
    </section>
  );
}
